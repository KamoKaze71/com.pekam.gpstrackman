...
public class DialogNewWaypoint extends DialogFragment {


    public static DialogNewWaypoint newInstance(String title) {
        DialogNewWaypoint frag = new DialogNewWaypoint();
    ...
    public Dialog onCreateDialog(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        return new AlertDialog.Builder(getActivity())
               // .setView(R.layout.dialog_fragment, null, savedInstanceState))
                .setCancelable(true)
